class HospitalsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to hospitals_path, status: :see_other, notice: "Hospital was successfully destroyed." }
  ...
  private
    ...
    def set_hospital
      @hospital = Hospital.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def hospital_params
      params.expect(hospital: [ :name ])
    end
end
